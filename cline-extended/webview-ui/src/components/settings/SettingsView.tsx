...
import ArchitectModeSection from "./sections/ArchitectModeSection"
...
export const SETTINGS_TABS: SettingsTab[] = [
	...
	},
	{
		id: "architect",
		name: "Architect",
		tooltipText: "Architect Mode Settings",
		headerText: "Architect Mode",
		icon: Brain,
	},
	{
		id: "features",
...
const SettingsView = ({ onDone, targetSection }: SettingsViewProps) => {
	...
	const TAB_CONTENT_MAP = useMemo(
		() => ({
			...
			architect: ArchitectModeSection,
